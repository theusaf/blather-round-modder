...
export class SetPromptSubcategoryNullable1692033731517
  implements MigrationInterface
{
  name = "SetPromptSubcategoryNullable1692033731517";
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "prompt" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "category" varchar(16) NOT NULL, "password" varchar(255) NOT NULL, "subcategory" varchar(255) NOT NULL, "us" boolean NOT NULL, "projectId" integer NOT NULL, CONSTRAINT "FK_c67590ca06752650fb3ab322a1f" FOREIGN KEY ("projectId") REFERENCES "project" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
