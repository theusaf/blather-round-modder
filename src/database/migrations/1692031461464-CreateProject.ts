...
export class CreateProject1692031461464 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "project" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255) NOT NULL, "ownerUsername" varchar NOT NULL, CONSTRAINT "UQ_dedfea394088ed136ddadeee89c" UNIQUE ("name"))`);
        ...
        await queryRunner.query(`INSERT INTO "temporary_project"("id", "name", "ownerUsername") SELECT "id", "name", "ownerUsername" FROM "project"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "project" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255) NOT NULL, "ownerUsername" varchar NOT NULL, CONSTRAINT "UQ_dedfea394088ed136ddadeee89c" UNIQUE ("name"))`);
        await queryRunner.query(`INSERT INTO "project"("id", "name", "ownerUsername") SELECT "id", "name", "ownerUsername" FROM "temporary_project"`);
